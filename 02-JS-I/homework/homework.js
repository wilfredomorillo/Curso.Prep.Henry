...
console.log(obtenerResto( 54 ,23));
...
console.log(redondearNumero(3.3));
...
console.log(agregarSimboloExclamacion('hola que hace'));
...
console.log(combinarNombres('wilfredo','morillo'));
...
function areaDelTriangulo(base, altura){
  ...
  //Escribe tu código aquí
  let miltiplica= base*altura 
  
 return miltiplica /2

}
console.log(areaDelTriangulo(4,6));
